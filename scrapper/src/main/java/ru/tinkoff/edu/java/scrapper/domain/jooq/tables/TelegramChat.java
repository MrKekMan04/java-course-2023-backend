...
public class TelegramChat extends TableImpl<TelegramChatRecord> {
     ...
     */
    public final TableField<TelegramChatRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>TELEGRAM_CHAT.REGISTERED_AT</code>.
     */
    public final TableField<TelegramChatRecord, OffsetDateTime> REGISTERED_AT = createField(DSL.name("REGISTERED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
