...
public class StackoverflowLink extends TableImpl<StackoverflowLinkRecord> {
     ...
     */
    public final TableField<StackoverflowLinkRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>STACKOVERFLOW_LINK.ANSWER_COUNT</code>.
     */
    public final TableField<StackoverflowLinkRecord, Long> ANSWER_COUNT = createField(DSL.name("ANSWER_COUNT"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>STACKOVERFLOW_LINK.SCORE</code>.
     */
    public final TableField<StackoverflowLinkRecord, Long> SCORE = createField(DSL.name("SCORE"), SQLDataType.BIGINT, this, "");
